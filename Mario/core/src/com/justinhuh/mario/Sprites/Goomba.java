...
public class Goomba extends Enemy {
    ...
    public Goomba(PlayScreen screen, float x, float y) {
        ...
        stateTime = 0;
        setBounds(getX(), getY(), 16 / MarioDemo.PPM, 16 / MarioDemo.PPM);
        setToDestroy = false;
        destroyed = false;
    }

    //gets status of goomba and removes if dead
    ...
    protected void defineEnemy() {
        ...
        fdef.shape = head;
        fdef.restitution = 0.5f; //Mario bounce factor
    ...
    public void hitOnHead(Mario mario) {
        setToDestroy = true;
        MarioDemo.manager.get("audio/sounds/stomp.wav", Sound.class).play();
